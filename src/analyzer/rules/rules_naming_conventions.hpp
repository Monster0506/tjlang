...
private:
    void checkFunctionNaming(const ast::FunctionDecl& func, std::vector<Issue>& issues);
    void checkParameterNaming(const ast::FunctionDecl& func, std::vector<Issue>& issues);
