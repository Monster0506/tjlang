...
mod advanced_collections_tests {
    ...
    fn test_counter_update() {
        ...
        COLLECTIONS::counter_update(&mut counter, vec!["b", "a", "c"].into_iter().map(|s| s.to_string()));
    ...
    fn test_chain_map_add_get() {
        ...
        assert_eq!(COLLECTIONS::chain_map_get(&chain, &"key2".to_string()), Some(&20));
        assert_eq!(COLLECTIONS::chain_map_get(&chain, &"key1".to_string()), Some(&1));
        assert_eq!(COLLECTIONS::chain_map_get(&chain, &"key3".to_string()), Some(&3));
    }
    ...
    fn test_chain_map_set() {
        ...
        assert_eq!(COLLECTIONS::chain_map_get(&chain, &"key".to_string()), Some(&42));
    }
    ...
    fn test_ordered_dict_move_to_end() {
        ...
        assert_eq!(keys, vec![&"second".to_string(), &"third".to_string(), &"first".to_string()]);
    }
    ...
    fn test_chain_map_priority() {
        ...
        assert_eq!(COLLECTIONS::chain_map_get(&chain, &"key".to_string()), Some(&2));
    }
